# BettingModel — Claude Code Guide
...
- **Never edit betting logic in Claude.** Odds, probabilities, edges, stakes, and pick selection all live in `predict_today.py`. Claude Code is orchestration only.
